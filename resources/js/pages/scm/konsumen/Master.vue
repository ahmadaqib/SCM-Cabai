    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          >
            <li class="nav-item">
              <router-link to="/konsumen/" class="nav-link">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Dashboard</p>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/konsumen/chat" class="nav-link">
            ...
            <li class="nav-item">
              <router-link to="/konsumen/distribusicabai" class="nav-link">
                <i class="fas fa-file-invoice nav-icon"></i>
                <p>Distribusi Cabai</p>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/konsumen/riwayatdistribusi" class="nav-link">
            ...
            <li class="nav-item">
              <router-link to="/konsumen/analitik" class="nav-link">
