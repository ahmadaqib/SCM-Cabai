    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          >
            <li class="nav-item">
              <router-link to="/grosir/" class="nav-link">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Dashboard</p>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/grosir/chat" class="nav-link">
            ...
            <li class="nav-item">
              <router-link to="/grosir/target" class="nav-link">
                <i class="fas fa-bullseye nav-icon"></i>
                <p>Rekap Target</p>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/grosir/penjualan" class="nav-link">
            ...
            <li class="nav-item">
              <router-link to="/grosir/harga" class="nav-link">
