    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          >
            <li class="nav-item">
              <router-link to="/pengecer/" class="nav-link">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Dashboard</p>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/pengecer/chat" class="nav-link">
            ...
            <!-- <li class="nav-item">
              <router-link to="/pengecer/pengajuanmitra" class="nav-link">
                <i class="fas fa-user-clock nav-icon"></i>
                <p>Pengajuan Mitra</p>
              </router-link>
            </li> -->
            ...
            <li class="nav-item">
              <router-link to="/pengecer/distribusicabai" class="nav-link">
                <i class="fas fa-file-invoice nav-icon"></i>
                <p>Distribusi Cabai</p>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/pengecer/riwayatdistribusi" class="nav-link">
            ...
            <li class="nav-item">
              <router-link to="/pengecer/target" class="nav-link">
                <i class="fas fa-bullseye nav-icon"></i>
                <p>Rekap Target</p>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/pengecer/penjualan" class="nav-link">
            ...
            <li class="nav-item">
              <router-link to="/pengecer/harga" class="nav-link">
